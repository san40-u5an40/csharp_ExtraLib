...
## Counter
### Назначение:
Статический класс для создания при помощи замыкания функции, возвращающей значение большее предыдущего на один при каждом вызове.

### Структура:
 - Create - принимает начальное значение и возвращает функцию счётчика.
