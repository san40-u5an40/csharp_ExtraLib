...
## Converter
### Назначение:
Статический класс для конвертирования различных единиц исчисления.

### Структура:
Статические методы:
 ToSize(Int) - Переводит полученное количество байт в набор гигабайт, мегабайт, килобайт и байт, представленный структурой Size.
...
foreach (var drive in drives)
{
    var str = new StringBuilder()
        ...
        .AppendLine("Общий размер: " + Converter.ToSize(drive.TotalSize));
